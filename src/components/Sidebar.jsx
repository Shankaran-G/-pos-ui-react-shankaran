...
const Sidebar = () => {
  ...
  return (
    <div className="sm:w-24 md:w-32 lg:w-64 bg-white text-gray-700 min-h-screen p-5 flex flex-col justify-between shadow">
      <div>
          ...
          {sections.map((item, index) => {
            ...
            return (
              <li
                ...
                } hover:text-[#2ac97b] cursor-pointer transition-colors duration-200`}
              >
